...
TableShape = draw2d.shape.layout.FlexGridLayout.extend({
    ...
    init : function(attr)
    {
    	this._super(
            ...
            stroke:1,
            radius:3,
            rows: "20px, 20px, 20px, 20px, 20px",
            columns: "20px, 20px, 20px",
        }, {row: 1, colspan: 3}));
        ...
        this.add(this.classLabel, {row: 0, colspan: 3});
    },
     ...
     setPersistentAttributes : function(memento)
     {
         ...
         if(typeof memento.entities !== "undefined"){
             $.each(memento.entities, $.proxy(function(i,e){
                 ...
                 entity.id = e.id;
                 entity.__cellConstraint.row = 1; //1행
                 entity.__cellConstraint.colspan = 3; //3열 통합
                 console.log(entity);
                 console.log(entity.__cellConstraint);
